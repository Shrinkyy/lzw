...
/**
 * @Author 娄志伟
 * @Create 2023/6/14 15:14
 */
public interface JobDao {
    /** 插入一条分类信息
     * @param job 包含了要添加的分类信息 其中id为空 因为id是自增长的 不需要开发者提供
     */
    void insert(Job job);
    ...
    /** 根据id或者name进行删除
     * @param job 如果提供的id不为空 则根据id删除 如果提供的name不为空 且id为空
     ...
     */
    List<Job> listByNameLike(String key);
}
